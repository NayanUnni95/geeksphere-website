...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const events = [
    {
      title: 'Geeksphere  team hiring',
      date: 'march 6 2024',
      buttontag: 'APPLY',
      url: 'https://forms.gle/BTYPntmXiVgW7P119',
    },
  ...
  events.forEach((event) => {
    ...
    eventTile.innerHTML = `
                        ...
                        <button class="btn btn-dark" onclick="window.location.href='${event.url}'">${event.buttontag}</button>`;
